...
protocol SoundStatusMethod { //this is for when you get back from text quiz and photo quiz
    
    func soundStatusIs(soundStatus: String, Audio: AVAudioPlayer)
}


class TextQuizViewController: UIViewController, SoundStringStatus {
 ...
 //UI connections
    ...
    var timer = Timer()
    var textQuestionArrayInstance = TextQuestionBank()
    ...
    func createNewQuestionAndFourChoices() {
        ...
        if textQuestionArrayInstance.randomQuestionArray[questionCounter].questionType == .normal {
        ...
        else if textQuestionArrayInstance.randomQuestionArray[questionCounter].questionType == .golden {
        ...
        else if textQuestionArrayInstance.randomQuestionArray[questionCounter].questionType == .mercy && noHeartCounter != 0{ //mercy question
    ...
    @IBAction func fourButtonChoices(_ sender: PressableButton) {
        ...
        if sender.titleLabel?.text == textQuestionArrayInstance.randomQuestionArray[questionCounter - 1].correctAnswer {
            
           if textQuestionArrayInstance.randomQuestionArray[questionCounter - 1].questionType == .normal {
            
            plusLabel.text = "+1"
            score = score + 1
            scoreLabel.text = String(score)
            }
             else if textQuestionArrayInstance.randomQuestionArray[questionCounter - 1].questionType == .golden {
...
//        present(alert, animated: true, completion: nil)
    ...
    func restartGame() {
        ...
        textQuestionArrayInstance = TextQuestionBank()
    ...
    func creatQuestionAndFourButtonsChoicesUI() {
        ...
        questionTextLabel.text = textQuestionArrayInstance.randomQuestionArray[questionCounter].questionText
        
        let btn1 = self.view.viewWithTag(textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][0]) as? PressableButton
        let btn2 = self.view.viewWithTag(textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][1]) as? PressableButton
        let btn3 = self.view.viewWithTag(textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][2]) as? PressableButton
        let btn4 = self.view.viewWithTag(textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][3]) as? PressableButton
        
        btn1?.setTitle(textQuestionArrayInstance.randomQuestionArray[questionCounter].correctAnswer, for: .normal)
        btn2?.setTitle(textQuestionArrayInstance.randomQuestionArray[questionCounter].wrongChoices[textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][0]], for: .normal)
        
        
        btn3?.setTitle(textQuestionArrayInstance.randomQuestionArray[questionCounter].wrongChoices[textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][1]], for: .normal)
        
        btn4?.setTitle(textQuestionArrayInstance.randomQuestionArray[questionCounter].wrongChoices[textQuestionArrayInstance.arrayOfNumbers[numberOfArrayCounter][2]], for: .normal)
